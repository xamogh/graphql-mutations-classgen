...
console.log(`Installing and compiling safe-urqlcodgen-mutations 0.1.0 ${features} ...`);
exec(`cargo install safe-urqlcodgen-mutations --vers 0.1.0 ${features}`, (error, stdout, stderr) => {
  console.log(stdout);
  if (error || stderr) {
