...
console.log(`Installing and compiling safe-urqlcodgen-mutations 2.0.1 ${features} ...`);
exec(`cargo install safe-urqlcodgen-mutations --vers 2.0.1 ${features}`, (error, stdout, stderr) => {
  console.log(stdout);
  if (error || stderr) {
